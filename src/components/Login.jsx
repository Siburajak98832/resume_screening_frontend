      ...
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-slate-600">
            {isRegister ? "Create your admin account to get started" : "Sign in to access the admin dashboard"}
          </p>
        </div>

        <Card className="shadow-xl border-slate-200 bg-white/80 backdrop-blur-sm">
          <CardHeader className="space-y-1 text-center bg-gradient-to-r from-slate-50 to-blue-50 rounded-t-lg border-b">
          ...
          <CardContent className="p-6 space-y-6">
            ...
            {/* <Button
              ...
              disabled={loading}
              variant="outline"
              className="w-full border-slate-200 bg-white hover:bg-slate-50 text-slate-700 py-6 text-base font-medium shadow-sm hover:shadow-md transition-all duration-200"
            >
